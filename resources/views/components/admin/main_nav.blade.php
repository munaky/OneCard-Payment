...
<nav class="w-[315px] fixed bottom-2 rounded-3xl bg-[#353648] drop-shadow-lg mx-2">
    <div class="flex items-center justify-between px-4 py-2">
        <a href="{{ url('/admin/home') }}" class="ml-5">
            <img src="{{ asset('assets/home.png') }}" alt="" class="w-5">
        </a>
        <a href="{{ url('/admin/history') }}" class="">
            <img src="{{ asset('assets/stopwatch.png') }}" alt="" class="w-5">
        </a>

        <a href="{{ url('/admin/scan') }}" class="bg-white rounded-full w-12 h-12 flex justify-center items-center">
        ...
        <a href="{{ url('/admin/profile') }}" class="mr-5">
