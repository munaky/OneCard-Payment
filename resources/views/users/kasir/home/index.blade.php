<div class="flex justify-between mt-3 px-3">
    <h5 class="tracking-wider text-[#353648] font-semibold">
        Histori akun</h5>
    <a href="{{ url('/kasir/history') }}" class="text-sm text-[#575872] mt-1 hover:underline">
        Lihat Semua</a>
</div>
...
<div
    ...
    <div class="w-max px-4 py-2 rounded-lg bg-[#4e546b]">
        ...
        <h5 class="text-white text-lg font-bold">Rp. {{ session()->get('settings')->balance }}</h5>
    </div>
    <div class="flex space-x-3 items-center">
        <h2 class="text-semibold text-white font-semibold tracking-wider">Set Value</h2>
        <a href="{{ url('/kasir/payment') }}"
